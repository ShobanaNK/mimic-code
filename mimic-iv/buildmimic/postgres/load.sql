...
\COPY mimiciv_hosp.admissions FROM admissions.csv DELIMITER ',' CSV HEADER NULL ''; --required
--\COPY mimiciv_hosp.d_hcpcs FROM d_hcpcs.csv DELIMITER ',' CSV HEADER NULL '';
\COPY mimiciv_hosp.diagnoses_icd FROM diagnoses_icd.csv DELIMITER ',' CSV HEADER NULL ''; -- required
...
\COPY mimiciv_hosp.labevents FROM labevents.csv DELIMITER ',' CSV HEADER NULL ''; -- required
...
\COPY mimiciv_hosp.patients FROM patients.csv DELIMITER ',' CSV HEADER NULL ''; -- required
