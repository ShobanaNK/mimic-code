...
DROP TABLE IF EXISTS r_icu_dataset; CREATE TABLE r_icu_dataset AS
SELECT 
    patients.subject_id
    , patients.gender
    , patients.dod
    ...
    , creatinine_min
    , creatinine_max
    , first_day_lab.glucose_min
    , first_day_lab.glucose_max
    , sodium_min
    , sodium_max
    , potassium_min
    , potassium_max
...
from
    patients,
    icustays,
    first_day_lab, first_day_vitalsign, age, first_day_height, first_day_weight, charlson
WHERE
 first_day_lab.subject_id = patients.subject_id 
 and first_day_lab.stay_id = icustays.stay_id 
 and icustays.subject_id = patients.subject_id 
 and first_day_vitalsign.subject_id = patients.subject_id 
 and first_day_vitalsign.stay_id = icustays.stay_id 
